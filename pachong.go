...
func main() {
	...
	url := "http://work.muxi-tech.xyz/api/v1.0/status/list/1/"
	method := "GET"
	...
	Error(err)
	req.Header.Add("token", "eyJhbGciOiJIUzI1NiIsImV4cCI6MTk1MzE3NjE4OSwiaWF0IjoxNjM3ODE2MTg5fQ.eyJjb25maXJtIjoyNTJ9.DTnByYL-b0r66VKN1a1dVgZO9S36xyvwGSFms3_Ml24")
